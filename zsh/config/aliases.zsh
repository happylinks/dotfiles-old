...
alias lc="ls -AlCF "
alias KABOOM="nvm use default && ((npm cache clean; npm update -g) & (brew update && brew reinstall --HEAD neovim && brew upgrade && brew cleanup -s --force && brew prune && brew cask cleanup && brew doctor)); source ~/.zshrc"
